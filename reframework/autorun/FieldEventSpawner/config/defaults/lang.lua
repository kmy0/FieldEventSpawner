...
return {
    ...
    menu = {
        config = {
            ...
            use_cache = "Cache Event Data",
            tooltip_use_cache = "Used to speed up mod initialization. Cache is remade automatically if you change any option affecting event data.",
            ...
            tooltip_add_nerscylla_clone = "Requires Script Reset. Adds DLC3 Monster Param to Nerscylla",
            ...
            add_invalid_swarm = "Add Any Monster Swarm",
            tooltip_add_invalid_swarm = "Requires Script Reset. Adds the Swarm Monster Param to all monsters, enabling Swarm spawns and Multi Monster Swarm Quests.",
        },
        language = {
            name = "Language",
            fallback = "Fallback",
